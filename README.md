...
The latest release is [2.6.4](https://github.com/nginx/nginx-gateway-fabric/releases/tag/v2.6.4).
...
| ------- | ----------- | ---------------------- | -------------------------- |
| Latest release | For production use | [Manifests](https://github.com/nginx/nginx-gateway-fabric/tree/v2.6.4/deploy). | [Documentation](https://docs.nginx.com/nginx-gateway-fabric). [Examples](https://github.com/nginx/nginx-gateway-fabric/tree/v2.6.4/examples). |
...
|----------------------|-------------|------------|-----------|------------|-------------|------------------|
| Edge                 | 1.5.1       | 1.31+      | 1.31.1    | R37.0      | v3.11.1     | 5.13.1           |
| 2.6.4                | 1.5.1       | 1.31+      | 1.31.1    | R37.0      | v3.11.1     | 5.13.1           |
