...
func (in *Compression) DeepCopyInto(out *Compression) {
	*out = *in
	if in.Gzip != nil {
		...
		*out = new(GzipSettings)
		(*in).DeepCopyInto(*out)
	}
	if in.Buffers != nil {
		in, out := &in.Buffers, &out.Buffers
		*out = new(CompressionBuffers)
		**out = **in
	}
	if in.Level != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CompressionBuffers) DeepCopyInto(out *CompressionBuffers) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CompressionBuffers.
func (in *CompressionBuffers) DeepCopy() *CompressionBuffers {
	if in == nil {
		return nil
	}
	out := new(CompressionBuffers)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GzipSettings) DeepCopyInto(out *GzipSettings) {
	*out = *in
	if in.Vary != nil {
		in, out := &in.Vary, &out.Vary
		*out = new(bool)
		**out = **in
	}
	if in.HTTPVersion != nil {
		in, out := &in.HTTPVersion, &out.HTTPVersion
		*out = new(GzipHTTPVersion)
		**out = **in
	}
	if in.Disable != nil {
	...
	if in.Proxied != nil {
		...
		*out = make([]GzipProxiedType, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GzipSettings.
func (in *GzipSettings) DeepCopy() *GzipSettings {
	if in == nil {
		return nil
	}
	out := new(GzipSettings)
...
func (in *NginxProxySpec) DeepCopyInto(out *NginxProxySpec) {
	*out = *in
	...
	if in.ServerTokens != nil {
		in, out := &in.ServerTokens, &out.ServerTokens
		*out = new(string)
		**out = **in
	}
...
func (in *WAFSpec) DeepCopyInto(out *WAFSpec) {
	*out = *in
	...
	if in.DisableCookieSeed != nil {
		in, out := &in.DisableCookieSeed, &out.DisableCookieSeed
		*out = new(bool)
		**out = **in
	}
	if in.BundleFailOpen != nil {
		in, out := &in.BundleFailOpen, &out.BundleFailOpen
		*out = new(bool)
		**out = **in
	}
}
