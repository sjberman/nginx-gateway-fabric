...
|-----|-------------|------|---------|
| `certGenerator` | The certGenerator section contains the configuration for the cert-generator Job. | object | `{"agentTLSSecretName":"agent-tls","annotations":{"test.com":"value"},"overwrite":false,"serverTLSSecretName":"server-tls"}` |
...
| `certGenerator.annotations` | The annotations of the cert-generator Job. | object | `{"test.com":"value"}` |
