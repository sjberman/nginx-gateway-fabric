...
func createStaticModeCommand() *cobra.Command {
	...
	const (
		...
		usageReportSkipVerifyFlag   = "usage-report-skip-verify" // TODO(sberman): need this?
	...
	cmd.MarkFlagsRequiredTogether(usageReportSecretFlag, plusFlag)
	...
	utilruntime.Must(cmd.Flags().MarkDeprecated(
		usageReportSkipVerifyFlag,
