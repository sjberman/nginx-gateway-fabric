...
If you need to update the JWT at any time, update the `license.jwt` field in the Secret using `kubectl edit` and apply the changes. NGINX Gateway Fabric will automatically detect the changes and use the new JWT in NGINX Plus.
