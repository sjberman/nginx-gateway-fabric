...
| _usage-report-endpoint_           | _string_ | The endpoint of the NGINX Plus usage reporting server. server.                                                                                                                                                                                                                                                                                                                            |
| _usage-report-resolver_         | _string_ | The nameserver used to resolve the NGINX Plus usage reporting server name.                                                                                                                                                                                                                                                                                                     |
